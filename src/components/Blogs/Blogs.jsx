...
const Blogs = () => {
   return (
      <div className=" pt-32 relative bg-gray-300   z-0 mx-auto">
         <div>
         ...
         <div className="container w-full mx-auto mt-4 p-4">
            ...
            <div>
               ...
               <p className="mt-2">
                  Ans :{" "}
                  <small>
                     In React, controlled components refer to components that
                     have their state and behavior controlled by the parent
                     component. These components rely on props passed down from
            ...
            <div className="mt-4">
               ...
               <p className="mt-2">
                  ...
                  <small>
                     ...
                     we're using PropTypes.string. When an invalid value is
                     provided for a prop, a warning will be shown in the
                     JavaScript console. For performance reasons, propTypes is
            ...
            <div className="mt-4">
               ...
               <p className="mt-2">
                  ...
                  <small>
                     ...
                     responses.js web application framework that provides a
            ...
            <div className="mt-4">
               ...
               <p className="mt-2">
                  ...
                  <small>
                     ...
                     so we will extract that into a custom Hook. Custom Hooks
                     are a mechanism to reuse stateful logic "such as setting up
                     a subscription and remembering the current value", but
                     every time you use a custom Hook, all state and effects
